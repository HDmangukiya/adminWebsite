...
public class BlogServiceImpl implements BlogService {
    ...
    public String saveBlog(Blog blog) {
        ...
        if (blogCategory == null) {
            ...
            blog.setBlogCategoryName("Default classification");
        } else {
            //设置博客分类名称
        ...
        if (tags.length > 6) {
            return "The number of tags is limited to 6";
        }
        //保存文章
        if (blogMapper.insertSelective(blog) > 0) {
            ...
            //Add tag data and modify the classification and sort values
    ...
    public String updateBlog(Blog blog) {
        ...
        if (blogCategory == null) {
            ...
            blogForUpdate.setBlogCategoryName("Default classification");
        } else {
            //设置博客分类名称
    ...
    public PageResult getBlogsPageByCategory(String categoryName, int page) {
        if (PatternUtil.validKeyword(categoryName)) {
            ...
            if ("Default classification".equals(categoryName) && blogCategory == null) {
    ...
    private BlogDetailVO getBlogDetailVO(Blog blog) {
        if (blog != null && blog.getBlogStatus() == 1) {
            ...
            if (blogCategory == null) {
                blogCategory = new BlogCategory();
                blogCategory.setCategoryId(0);
                blogCategory.setCategoryName("Default classification");
        ...
        if (!CollectionUtils.isEmpty(blogList)) {
            ...
            for (Blog blog : blogList) {
                ...
                if (blogCategoryMap.containsKey(blog.getBlogCategoryId())) {
                    ...
                    blogListVO.setBlogCategoryName("Default classification");
